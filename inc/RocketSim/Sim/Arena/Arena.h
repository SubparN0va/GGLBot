...
#include "RocketSim/Sim/SuspensionCollisionGrid/SuspensionCollisionGrid.h"
...
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionShapes/btStaticPlaneShape.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionShapes/btBvhTriangleMeshShape.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionDispatch/btCollisionDispatcher.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletDynamics/ConstraintSolver/btSequentialImpulseConstraintSolver.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletDynamics/Dynamics/btDiscreteDynamicsWorld.h"
...
public:
	...
	// Returns cars in a deterministic order (team, then car id)
	RSAPI void GetCarsOrdered(std::vector<Car*>& out) const;
