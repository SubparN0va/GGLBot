...
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/BroadphaseCollision/btAxisSweep3.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/BroadphaseCollision/btDbvtBroadphase.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/BroadphaseCollision/btSimpleBroadphase.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/BroadphaseCollision/btRSBroadphase.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/BroadphaseCollision/btOverlappingPairCache.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionDispatch/btInternalEdgeUtility.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionShapes/btBoxShape.h"
#include "RocketSim/libsrc/bullet3-3.24/BulletCollision/CollisionShapes/btSphereShape.h"
...
void Arena::GetCarsOrdered(std::vector<Car*>& out) const {
	out.clear();
	out.reserve(_cars.size());
	for (Car* c : _cars)
		out.push_back(c);

	std::sort(out.begin(), out.end(), [](const Car* a, const Car* b) {
		if ((int)a->team != (int)b->team) return (int)a->team < (int)b->team;
		return a->id < b->id;
	});
}
